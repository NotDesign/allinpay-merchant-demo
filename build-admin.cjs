...
const extension = ['backoffice-extension.js','current-backoffice.js','onboarding-v2-data.js','onboarding-v2.js','br-integration.js','onboarding-risk.js','internal-review.js'].map(read).join('\n');
