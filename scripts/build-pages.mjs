...
const files=['index.html','backoffice.html','external.html','app.js','data.js','styles.css','backoffice.css','current-backoffice.css','onboarding-v2.css','br-integration.css','internal-review.css','robots.txt','THIRD_PARTY_NOTICES.md'];
...
const version={version:'2026.09.24-internal-review-console',builtAt:new Date().toISOString(),commit:process.env.GITHUB_SHA||'local',brLocalOCR:true};
